/*
    ...
    all files along with its name into newly craeted file "Marvellous.txt"
*/
...
class Demo
{
    void WriteFileData(String dir, String Filename)  throws IOException
    {
        ...
        System.out.println("Files Contents successfully written inside Marvellous.txt with file names");
    }
}
